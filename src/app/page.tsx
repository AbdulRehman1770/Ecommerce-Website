...
//   const [cart, setCart] = useState<Product[]>([]); // List of items added to cart

//   // Fetching Products From Api's 
...
//             <div className="md:w-80 md:h-80 lg:w-96 lg:h-96 w-60 h-72 grid grid-rows-11 rounded-lg shadow-xl">
//               {/* <img src={product.image} alt={product.name} className="bg-red-500 md:w-80 rounded-lg lg:h-60 h-44 lg:w-96 w-60 row-span-6" /> */}

//               <div className="bg-red-500 md:w-80 rounded-lg lg:h-52 h-40 lg:w-96 w-60 row-span-6 opacity-0 transition-opacity duration-1000 ease-in-out" onLoad={(e) => e.currentTarget.classList.add("opacity-100")}>
...
//               {/* <div key={product.id} className="bg-blue-500 "></div> */}
